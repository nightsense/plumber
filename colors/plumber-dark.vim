...
cal <sid>h('Debug'            , s:g6 , s:gE , s:t6 , s:tE   , ''          , ''  )
cal <sid>h('Delimiter'        , s:g6 , s:gE , s:t6 , s:tE   , ''          , ''  )
cal <sid>h('Special'          , s:g6 , s:gE , s:t6 , s:tE   , 'none'      , ''  )
cal <sid>h('SpecialChar'      , s:g6 , s:gE , s:t6 , s:tE   , ''          , ''  )
cal <sid>h('SpecialComment'   , s:g6 , s:gE , s:t6 , s:tE   , ''          , ''  )
cal <sid>h('SpecialKey'       , s:g6 , s:gE , s:t6 , s:tE   , 'none'      , ''  )
cal <sid>h('SpellRare'        , ''   , ''   , s:tE , s:t0 , 'undercurl' , s:gE)
cal <sid>h('Tag'              , s:g6 , s:gE , s:t6 , s:tE   , ''          , ''  )
